...
Pester\Describe "Manifest" {
    ...
    Pester\It "has a valid guid" {
        $ManifestHash.Guid | Should Be "16077f6b-5b6a-4f55-a9b1-f44b05159de8"
    }
    ...
    Pester\It 'has a valid license Uri' {
        $ManifestHash.PrivateData.Values.LicenseUri | Should Be "https://github.com/andysimmons/PSRhapsody/blob/master/PSRhapsody/license"
    }
    
    Pester\It 'has a valid project Uri' {
        $ManifestHash.PrivateData.Values.ProjectUri | Should Be "https://github.com/andysimmons/PSRhapsody"
    }
